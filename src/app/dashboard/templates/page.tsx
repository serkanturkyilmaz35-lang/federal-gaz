...
const defaultTemplates: EmailTemplate[] = [
    // Genel
    { id: 1, slug: 'modern', nameTR: 'Modern', nameEN: 'Modern', category: 'general', headerBgColor: 'linear-gradient(135deg, #1a2744 0%, #0a1628 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: 'linear-gradient(135deg, #b13329 0%, #8b1a12 100%)', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 1 },
    ...
    { id: 27, slug: 'welcome', nameTR: 'Hoş Geldiniz', nameEN: 'Welcome', category: 'general', headerBgColor: 'linear-gradient(135deg, #1a2744 0%, #2d4a7c 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#b13329', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 27 },
    { id: 26, slug: 'vip-customer', nameTR: 'VIP Müşteri', nameEN: 'VIP Customer', category: 'general', headerBgColor: 'linear-gradient(135deg, #2c3e50 0%, #1a252f 100%)', headerTextColor: '#ffd700', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#c41e3a', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 26 },
    // Bayram
    { id: 10, slug: 'new-year', nameTR: 'Yeni Yıl', nameEN: 'New Year', category: 'holiday', headerBgColor: 'linear-gradient(135deg, #1e3a5f 0%, #0d1f33 100%)', headerTextColor: '#ffd700', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#c41e3a', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 10 },
    { id: 15, slug: 'ramazan-bayrami', nameTR: 'Ramazan Bayramı', nameEN: 'Eid al-Fitr', category: 'holiday', headerBgColor: 'linear-gradient(135deg, #1e3c72 0%, #2a5298 100%)', headerTextColor: '#ffd700', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#4ecdc4', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 15 },
    { id: 16, slug: 'kurban-bayrami', nameTR: 'Kurban Bayramı', nameEN: 'Eid al-Adha', category: 'holiday', headerBgColor: 'linear-gradient(135deg, #2d3436 0%, #000000 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#b13329', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 16 },
    { id: 11, slug: '23-nisan', nameTR: '23 Nisan', nameEN: '23 April', category: 'holiday', headerBgColor: 'linear-gradient(135deg, #e30a17 0%, #b30813 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#1a2744', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 11 },
    // Promosyon
    { id: 30, slug: 'black-friday', nameTR: 'Efsane Cuma', nameEN: 'Black Friday', category: 'promotion', headerBgColor: 'linear-gradient(135deg, #000000 0%, #1a1a2e 50%, #16213e 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#ff2d2d', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 30 },
    { id: 31, slug: 'weekend-sale', nameTR: 'Hafta Sonu İndirimi', nameEN: 'Weekend Sale', category: 'promotion', headerBgColor: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#f093fb', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 31 },
    { id: 32, slug: 'winter-campaign', nameTR: 'Kış Kampanyası', nameEN: 'Winter Campaign', category: 'promotion', headerBgColor: 'linear-gradient(135deg, #74ebd5 0%, #ACB6E5 100%)', headerTextColor: '#1a2744', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#1a2744', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 32 },
    { id: 3, slug: 'promotion', nameTR: 'Kampanya / İndirim', nameEN: 'Promotion', category: 'promotion', headerBgColor: 'linear-gradient(135deg, #ff6b35 0%, #f7931e 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#1a2744', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 20 },
    { id: 4, slug: 'stock-reminder', nameTR: 'Stok Hatırlatma', nameEN: 'Stock Reminder', category: 'promotion', headerBgColor: 'linear-gradient(135deg, #2ecc71 0%, #27ae60 100%)', headerTextColor: '#ffffff', bodyBgColor: '#ffffff', bodyTextColor: '#333333', buttonColor: '#1a2744', footerBgColor: '#1a2744', footerTextColor: '#888888', headerHtml: '', footerHtml: '', isActive: true, sortOrder: 21 },
];
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-4 rounded-lg border border-blue-500/30 bg-blue-500/5">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="color" value={editingTemplate.headerBgColor.startsWith('#') ? editingTemplate.headerBgColor : '#1a2744'}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, headerBgColor: e.target.value })}
                                                    className="w-10 h-10 rounded cursor-pointer" />
                                                <input type="text" value={editingTemplate.headerBgColor}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, headerBgColor: e.target.value })}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="color" value={editingTemplate.headerTextColor}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, headerTextColor: e.target.value })}
                                                    className="w-10 h-10 rounded cursor-pointer" />
                                                <input type="text" value={editingTemplate.headerTextColor}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, headerTextColor: e.target.value })}
                                                    className="flex-1 px-3 py-2 bg-[#111418] border border-[#3b4754] rounded-lg text-white text-sm" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="mt-4 grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="text" value={editingTemplate.logoUrl || ''} placeholder="URL veya yükle"
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, logoUrl: e.target.value })}
                                                    className="flex-1 px-3 py-2 bg-[#111418] border border-[#3b4754] rounded-lg text-white text-sm" />
                                                <label className="px-3 py-2 bg-gray-700 rounded-lg cursor-pointer hover:bg-gray-600">
                                        ...
                                        <div>
                                            <label className="block text-xs font-medium text-gray-400 mb-1">Banner Görsel</label>
                                            <div className="flex gap-2">
                                                <input type="text" value={editingTemplate.bannerImage || ''} placeholder="URL veya yükle"
                                    ...
                                    <div className="mt-4 rounded overflow-hidden">
                                        <div className="h-16 flex items-center justify-center" style={{ background: editingTemplate.headerBgColor }}>
                                            {editingTemplate.logoUrl && <img src={editingTemplate.logoUrl} alt="Logo" className="h-8 mr-4" />}
                                            <span className="font-bold" style={{ color: editingTemplate.headerTextColor }}>{editingTemplate.nameTR}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 rounded-lg border border-green-500/30 bg-green-500/5">
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="color" value={editingTemplate.bodyBgColor || '#ffffff'}
                                                    ...
                                                    className="w-10 h-10 rounded cursor-pointer" />
                                                <input type="text" value={editingTemplate.bodyBgColor || '#ffffff'}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, bodyBgColor: e.target.value })}
                                                    className="flex-1 px-3 py-2 bg-[#111418] border border-[#3b4754] rounded-lg text-white text-sm" />
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="color" value={editingTemplate.bodyTextColor || '#333333'}
                                                    ...
                                                    className="w-10 h-10 rounded cursor-pointer" />
                                                <input type="text" value={editingTemplate.bodyTextColor || '#333333'}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, bodyTextColor: e.target.value })}
                                                    className="flex-1 px-3 py-2 bg-[#111418] border border-[#3b4754] rounded-lg text-white text-sm" />
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="color" value={editingTemplate.buttonColor.startsWith('#') ? editingTemplate.buttonColor : '#b13329'}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, buttonColor: e.target.value })}
                                                    className="w-10 h-10 rounded cursor-pointer" />
                                                <input type="text" value={editingTemplate.buttonColor}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, buttonColor: e.target.value })}
                                                    className="flex-1 px-3 py-2 bg-[#111418] border border-[#3b4754] rounded-lg text-white text-sm" />
                                            </div>
                                        </div>
                                    ...
                                    {/* Body Preview */}
                                    <div className="mt-4 p-4 rounded" style={{ background: editingTemplate.bodyBgColor || '#ffffff' }}>
                                        <p style={{ color: editingTemplate.bodyTextColor || '#333333' }} className="text-sm">Merhaba <strong>Müşteri Adı</strong>,</p>
                                        <p style={{ color: editingTemplate.bodyTextColor || '#333333' }} className="text-sm my-2">E-posta içeriği burada görünecek...</p>
                                        <div className="text-center mt-4">
                                            <span className="inline-block px-6 py-2 text-white rounded" style={{ background: editingTemplate.buttonColor }}>Buton</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 rounded-lg border border-orange-500/30 bg-orange-500/5">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="color" value={editingTemplate.footerBgColor || '#1a2744'}
                                                    ...
                                                    className="w-10 h-10 rounded cursor-pointer" />
                                                <input type="text" value={editingTemplate.footerBgColor || '#1a2744'}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, footerBgColor: e.target.value })}
                                                    className="flex-1 px-3 py-2 bg-[#111418] border border-[#3b4754] rounded-lg text-white text-sm" />
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input type="color" value={editingTemplate.footerTextColor || '#888888'}
                                                    ...
                                                    className="w-10 h-10 rounded cursor-pointer" />
                                                <input type="text" value={editingTemplate.footerTextColor || '#888888'}
                                                    onChange={(e) => setEditingTemplate({ ...editingTemplate, footerTextColor: e.target.value })}
                                                    className="flex-1 px-3 py-2 bg-[#111418] border border-[#3b4754] rounded-lg text-white text-sm" />
                                            </div>
                                        </div>
                                    ...
                                    {/* Footer Preview */}
                                    <div className="mt-4 p-4 rounded text-center" style={{ background: editingTemplate.footerBgColor || '#1a2744' }}>
                                        <p style={{ color: editingTemplate.footerTextColor || '#888888' }} className="text-xs">© 2014 Federal Gaz - Ankara</p>
                                    </div>
                                </div>
                            </div>
                                    </div>
