                    ...
                    <div className="flex justify-center px-4 lg:px-10">
                        <div className="flex w-full max-w-7xl items-center justify-between whitespace-nowrap border-b border-solid border-secondary/10 py-3 dark:border-white/10">
                            ...
                            <nav className="hidden flex-1 items-center justify-center gap-9 lg:flex">
                                ...
                                <Link href="/hizmetler" className="text-sm font-medium leading-normal text-primary dark:text-primary">Hizmetlerimiz</Link>
                ...
                <main className="flex-1">
                    <section className="bg-secondary py-16 text-white">
                        <div className="mx-auto max-w-7xl px-4">
                            <h1 className="text-4xl font-black leading-tight tracking-[-0.033em] md:text-5xl">Hizmetlerimiz</h1>
                            <p className="mt-4 text-lg text-white/80">Endüstriyel gaz ihtiyaçlarınız için kapsamlı çözümler sunuyoruz.</p>
                        </div>
                    </section>
                    ...
                    <section className="bg-background-light py-16 dark:bg-background-dark sm:py-24">
                        <div className="mx-auto max-w-7xl px-4">
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                                {[
                                    { icon: "science", title: "Medikal Gazlar", desc: "Sağlık sektörünün hassas ihtiyaçlarına yönelik yüksek saflıkta medikal gaz tedariki ve sistemleri." },
                                    { icon: "local_fire_department", title: "Endüstriyel Gaz Dolumu", desc: "Oksijen, azot, argon ve diğer endüstriyel gazların güvenli ve hızlı dolum hizmetleri." },
                                    { icon: "ac_unit", title: "Kriyojenik Tank Hizmetleri", desc: "Kriyojenik tankların kurulumu, bakımı ve periyodik kontrolleri için uzman teknik destek." },
                                    { icon: "build", title: "Kaynak Gazları", desc: "Kaynak işlemleriniz için özel karışım gazlar ve ekipman tedariki." },
                                    { icon: "restaurant", title: "Gıda Gazları", desc: "Gıda endüstrisi için güvenli ve onaylı gaz çözümleri." },
                                    { icon: "settings", title: "Özel Gaz Karışımları", desc: "İhtiyaçlarınıza özel hazırlanan gaz karışımları ve danışmanlık hizmetleri." }
                                ].map((service, i) => (
                                    <div key={i} className="flex flex-col items-center rounded-xl bg-white p-8 text-center shadow-md dark:bg-background-dark">
