                    ...
                    <div className="flex justify-center px-4 lg:px-10">
                        <div className="flex w-full max-w-7xl items-center justify-between whitespace-nowrap border-b border-solid border-secondary/10 py-3 dark:border-white/10">
                            ...
                            <nav className="hidden flex-1 items-center justify-center gap-9 lg:flex">
                                ...
                                <Link href="/iletisim" className="text-sm font-medium leading-normal text-secondary transition-colors hover:text-primary dark:text-white">İletişim</Link>
                            </nav>
                ...
                <main className="flex-1">
                    <section className="bg-secondary py-16 text-white">
                        <div className="mx-auto max-w-7xl px-4">
                            <h1 className="text-4xl font-black leading-tight tracking-[-0.033em] md:text-5xl">Sipariş Ver</h1>
                            <p className="mt-4 text-lg text-white/80">Hızlı ve güvenli sipariş için formu doldurun.</p>
                        </div>
                    </section>
                                ...
                                <form className="space-y-6">
                                    <div className="grid gap-6 md:grid-cols-2">
                                        <div>
                                            ...
                                            <input type="text" required className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white" />
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-secondary dark:text-white">Firma *</label>
                                            <input type="text" required className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white" />
                                        </div>
                                    </div>
                                    <div className="grid gap-6 md:grid-cols-2">
                                        <div>
                                            ...
                                            <input type="email" required className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white" />
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-secondary dark:text-white">Telefon *</label>
                                            <input type="tel" required className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white" />
                                        </div>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-secondary dark:text-white">Ürün *</label>
                                        <select required className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white">
                                            <option value="">Ürün Seçiniz</option>
                                            <option>Oksijen</option>
                                            <option>Azot</option>
                                            <option>Argon</option>
                                            <option>Karbondioksit</option>
                                            <option>Asetilen</option>
                                            <option>Propan</option>
                                            <option>Medikal Oksijen</option>
                                            <option>Diğer</option>
                                        </select>
                                    </div>
                                    <div className="grid gap-6 md:grid-cols-2">
                                        <div>
                                            <label className="text-sm font-medium text-secondary dark:text-white">Miktar *</label>
                                            <input type="number" required min="1" className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white" />
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-secondary dark:text-white">Birim</label>
                                            <select className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white">
                                                <option>Adet</option>
                                                <option>m³</option>
                                                <option>kg</option>
                                                <option>Litre</option>
                                    ...
                                    <div>
                                        <label className="text-sm font-medium text-secondary dark:text-white">Teslimat Adresi *</label>
                                        <textarea required rows={3} className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white"></textarea>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-secondary dark:text-white">Ek Notlar</label>
                                        <textarea rows={3} className="mt-1 w-full rounded-lg border border-secondary/20 bg-background-light px-4 py-2 text-secondary dark:bg-background-dark dark:text-white" placeholder="Varsa ek taleplerinizi belirtin..."></textarea>
                                    </div>
