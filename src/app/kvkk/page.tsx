    ...
    useEffect(() => {
        const fetchPage = async () => {
            try {
                ...
                const res = await fetch(`/api/pages/kvkk?${params}`);
                if (res.ok) {
                    ...
                    {loading ? (
                        ...
                        <div
                            ...
                            className="prose prose-lg dark:prose-invert max-w-none
                                ...
                                [&_.disclaimer]:mt-6 [&_.disclaimer]:text-gray-500 dark:[&_.disclaimer]:text-gray-500 [&_.disclaimer]:text-sm"
                        />
                    ) : (
...
function FallbackContent({ language, companyName, email, phone, address }: { language: string; companyName: string; email: string; phone: string; address: string }) {
        ...
        return (
            <div className="prose prose-lg dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-400">
                    {companyName} processes your personal data in accordance with KVKK.
                </p>
    ...
    return (
        <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-gray-600 dark:text-gray-400">
                6698 sayılı KVKK kapsamında kişisel verileriniz işlenmektedir.
            </p>
