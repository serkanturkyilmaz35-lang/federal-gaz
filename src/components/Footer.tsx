                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    <div className="md:col-span-1">
                        <Link href="/" title={language === 'TR' ? 'Federal Gaz Ana Sayfa' : 'Federal Gaz Home'} className="inline-block">
                            <h3 className="mb-4 text-lg font-bold text-white hover:text-primary transition-colors">Federal Gaz</h3>
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="tel:+903123953595" title="Federal Gaz Telefon" className="transition-colors hover:text-primary">(0312) 395 35 95</a></li>
                            <li><a href="tel:+905434554563" title="Federal Gaz Cep Telefonu" className="transition-colors hover:text-primary">(+90) 543 455 45 63</a></li>
                            <li><a href="tel:+905324224515" title="Federal Gaz Cep Telefonu" className="transition-colors hover:text-primary">(+90) 532 422 45 15</a></li>
                            <li><a href="mailto:federal.gaz@hotmail.com" title="Federal Gaz E-posta" className="transition-colors hover:text-primary">federal.gaz@hotmail.com</a></li>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/federal_gaz/" target="_blank" rel="noopener noreferrer" title="Federal Gaz Instagram" className="transition-colors hover:text-primary">
