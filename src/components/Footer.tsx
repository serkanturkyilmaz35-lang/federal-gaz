                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="mailto:federal.gaz@hotmail.com" className="transition-colors hover:text-primary">federal.gaz@hotmail.com</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="/galeri" className="transition-colors hover:text-primary">{t.gallery}</Link></li>
